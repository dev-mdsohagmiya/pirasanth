  ...
  return (
    <div className="md:hidden ">
      ...
      >
        ...
        <div className="pt-5 text-[17px] text-white mx-10 ">
          <ul>
            <li className="hover:text-primary cursor-pointer py-4">
            ...
            <ul className="mr-20 mb-10">
              <li className="inline-block p-2 cursor-pointer">
                <svg
                  ...
                  height="25"
                  fill="currentColor"
                  className="bi bi-linkedin text-white hover:text-primary"
                  viewBox="0 0 16 16"
                >
              ...
              <li className="inline-block p-2 cursor-pointer">
                <svg
                  ...
                  height="25"
                  fill="currentColor"
                  className="bi bi-instagram text-white hover:text-primary"
                  viewBox="0 0 16 16"
                >
              ...
              <li className="inline-block p-2 cursor-pointer hover:text-primary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="25"
                  fill="currentColor"
                  className="bi bi-github text-white hover:text-primary"
                  viewBox="0 0 16 16"
                >
