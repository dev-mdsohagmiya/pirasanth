...
const Sidebar = ({ value }: SidebarProps) => {
  return (
    <div className="md:hidden ">
      <div
        className={`fixed inset-0 w-[calc(90%-4.5rem)] translate-x-[${value}] border-r  shadow-xl transition duration-300 peer-checked:translate-x-0 lg:static lg:w-auto lg:translate-x-0 lg:border-r-0 lg:shadow-none bg-secondary `}
      >
